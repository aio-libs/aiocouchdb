...
class UserDocumentTestCase(utils.TestCase):
    ...
    def setUp(self):
        super().setUp()
        docid = aiocouchdb.document.UserDocument.doc_prefix + 'username'
        self.url_doc = urljoin(self.url, '_users', docid)
        self.doc = aiocouchdb.document.UserDocument(self.url_doc, docid=docid)

    def test_require_docid(self):
        with self.assertRaises(ValueError):
            aiocouchdb.document.UserDocument(self.url_doc)
